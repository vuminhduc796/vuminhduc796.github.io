function switchConcept() {
    ...
    document.getElementById("tech04").innerHTML = "Android App Development"
    ...
    document.getElementById("tech14").style.width = "55%";
}
function switchLanguage() {
    ...
    document.getElementById("tech04").innerHTML = "C and Assembly Languanges"
    ...
    document.getElementById("tech14").style.width = "42%";
}